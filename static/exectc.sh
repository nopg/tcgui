...
sudo tc qdisc add dev $eth1 parent 1:1 handle 10: netem delay ${latency2}ms ${jitter2}ms loss ${loss2}
sudo tc qdisc add dev $eth2 parent 2:1 handle 10: netem delay ${latency2}ms ${jitter2}ms loss ${loss2}
